  ...
  describe '予約時の金額計算' do
    ...
    context '大人だけの時' do
      ...
      it '基本料金 × 泊数 × 大人数 × 税率で計算されること' do
        reservation = build(:reservation, room_type:, user:, check_in_date:, nights:, adults: 2, children: 0)
    ...
    context '大人と子どもの時' do
      ...
      it '大人料金と子供料金を合算して税込み計算されること' do
        reservation = build(:reservation, room_type:, user:, check_in_date:, nights:, adults: 2, children: 3)
        reservation.calculate_total_amount
    ...
    context '子供料金が端数になるパターンの時' do
      let(:room_type) { create(:room_type, accommodation:, base_price: 10003, capacity: 5) }
      let(:nights) { 1 }
      ...
      it '子供料金計算時に端数が切り捨てられること' do
        reservation = build(:reservation, room_type:, user:, check_in_date:, nights:, adults: 1, children: 1)
        reservation.calculate_total_amount
